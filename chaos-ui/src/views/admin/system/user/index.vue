<template>
	<div class="layout-padding">
				...
				<div class="layout-padding-auto layout-padding-view">
					<el-row v-show="showSearch">
						<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList">
							...
							<el-form-item :label="$t('sysuser.phone')" prop="tel">
								<el-input v-model="state.queryForm.tel" :placeholder="$t('sysuser.inputPhoneTip')" clearable />
							</el-form-item>
							<el-form-item>
					...
					>
						...
						<el-table-column :label="$t('sysuser.phone')" prop="tel" show-overflow-tooltip></el-table-column>
						<el-table-column :label="$t('sysuser.dept')" show-overflow-tooltip>
							<template #default="scope">
								<el-tag v-for="(item, index) in scope.row.deptList" :key="index">{{ item.name }}</el-tag>
							</template>
						</el-table-column>
		...
		<UserForm ref="userDialogRef" @refresh="getDataList(false)" :deptId="state.queryForm.deptId" />
